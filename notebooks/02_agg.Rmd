...
categoricas_nd_spnn1 <- get_var_from_type(estructura,"categorica_5")
data[,categoricas_5]  <- data[,categoricas_5] %>% 
  mutate_all(funs(recode(var = ., 
                         recodes = "0=0;
                         1=0;2=75;
...
#nd_nsnn4 y nd_nsnn1 {""0-NA""|""1-si""|""2-no""|"
#"8-info no disponible""|""9-no se sabe"
# aut_cobr {"0-NA"|"1-gobierno municipal"|"2-gobierno de la Entidad Federativa"|"3-No se cobra"|"9-No se sabe"|}'
```
