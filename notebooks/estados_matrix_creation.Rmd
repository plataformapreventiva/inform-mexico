...
periodistas <- large_table(con,raw,imco_periodistas)  %>% retrieve_result()
equidad_congreso <- large_table(con,raw,imco_equidad_congreso) %>% retrieve_result()
...
#info_publica <- large_table(con,raw,imco_info_publica)
#equidad_congreso <- large_table(con,raw,imco_participacion_ciudadana)
#equidad_congreso <- large_table(con,raw,imco_marimonio_igualitario)
